		...
		$.ajax({
			...
			success:function(value){
				...
				var result= value.map(function(x){
					return "<tr> <td><div class='custom-control custom-checkbox mb-3'><input type='checkbox' class='custom-control-input'  value='"+x.idSanPham+"' id='id"+x.idSanPham+"' ><label class='custom-control-label' for='id"+x.idSanPham+"'></label> </div> </td> <td>"+x.idSanPham+"</td><td>"+x.tenSanPham+"</td><td>"+x.giaTien+"</td><td>"+x.tongSoLuong+"</td><td id='DanhMuc' data-idDanhMuc='"+x.idDanhMuc+"'>"+x.tenDanhMuc+"</td> <td> <button class='btn btn-warning edit'>edit</button></td></tr>";
				})
...
// redirect product/idDanhMuc
		$("body").off("click").on("click","#DanhMuc",function(){
...
//function update product 
		function updateProduct(){
				...
				var dataSanPham={};
				 ...
				 dataSanPham["hinhSanPham"]= objectImage2;
				 console.log(dataSanPham["hinhSanPham"])
				dataSanPham["idSanPham"]=$("#content-tenSanPham").attr("data-idSP");
