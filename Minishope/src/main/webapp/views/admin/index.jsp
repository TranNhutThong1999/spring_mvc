...
<body>
	...
	<div id="main" class="main-admin float-right" data-soLuongSP="${soLuongSP}">
	...
	<form id="form-themSP">
		...
		<div id="hinhSanPham" class="mt-2">
			...
			<div class="custom-file" >
			    <input type="file" multiple  id="fileName" name ="hinhSanPham">
			    <!-- <label  class="custom-file-label" for="fileName"></label> class="custom-file-input" -->
			 </div>
		</div>
		<div id="moTa">
	...
	<div id="clone" class="CTSP-content">
		...
		<div class="content" style="margin: 0px auto; width: 91%">
			...
			<table class="table">
				<thead id="title-paging" idDanhMuc="${idDanhMuc}">
					<tr>
						...
						<th class="sort-title" data-sort="" sortBy="giaTien">Số lượng</th>
