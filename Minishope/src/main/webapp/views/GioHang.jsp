...
<link rel="stylesheet" href='<c:url value="/resources/css/GioHang.css" />'>
...
<body>
	...
	<div class="container-fluid giohang background">
		...
		<form id="form-data" method="post" action='<c:url value="/HoaDon/ThemHoaDon/"></c:url>'>
			<div class="row">
					...
					<div class="title">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">Tên</label> <input type="text" name="tenKhachHang"
								class="form-control input" id="exampleInputEmail1"
								aria-describedby="emailHelp" placeholder="Tên người nhận">
						</div>
						<div class="form-group">
							<label  for="exampleInputPassword1">Số điện thoại liên lạc</label>
							<input id="soDT" type="phone" class="form-control input" name="soDT" require pattern="^0+[0-9]{8}"
						...
						<div class="form-group">
							<input type="text" class="form-control input" id="address" name="diaChiGiaoHang"
								aria-describedby="emailHelp" placeholder="Đia chỉ nhận hàng">
						</div>
						<div class="form-group">
							<label for="note">Ghi chú</label> <input type="text" name="ghiChu"
								class="form-control input" id="note" aria-describedby="emailHelp"
								placeholder="">
						</div>
				...
				<div class="right col-md-6">
					...
					<hr>
					<button id="Create" type="submit" class="btn btn-primary btn-lg">Đặt hàng</button>
				</div>
			...
			$("#form-data").submit(function(e){
				$(".input").each(function(){
					if($(this).val()===""){
						...
						swal({
							  title: "Warning?",
							  text: "Vui long không để trống thông tin!",
							  type: "warning",
