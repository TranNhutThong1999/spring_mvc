...
public class SanPhamService implements ISanPhamService {
	...
	public void update(SanPhamDTO spDTO) {
		...
		SanPham sp2 = sanPhamDAO.findOneById(sp.getIdSanPham());
		List<HinhSanPham> hsp= sp.getHinhSanPham();
		List<HinhSanPham>	hsp2=sp2.getHinhSanPham();
		for(HinhSanPham s2 :hsp2) {
			hsp.add(s2);
		}
		sp.setHinhSanPham(hsp);
		System.out.println(sp.getHinhSanPham().toString());
